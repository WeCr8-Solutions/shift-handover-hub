...
DROP POLICY IF EXISTS "Public can read flyer promo media" ON storage.objects;
CREATE POLICY "Public can read flyer promo media"
  ON storage.objects FOR SELECT
  TO anon, authenticated
  USING (bucket_id = 'flyer-promo-media');