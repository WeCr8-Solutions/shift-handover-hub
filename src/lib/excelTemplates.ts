...
// Template data with sample rows - matches the new consolidated template structure
export const STATIONS_TEMPLATE = {
  ...
  sampleData: [
    ...
    ['INSP-001', 'CMM Station', 'Quality Lab', 'Outgoing Inspection', '', 'Quality', 'yes'],
    ['SAW-001', 'Saw Station 1', 'Cutting Area', 'Band Saw', '', 'Cutting', 'yes'],
    ['DEB-001', 'Deburr Station 1', 'Finishing Area', 'Deburr Station', '', '', 'yes'],
    ['PKG-001', 'Packaging Station 1', 'Shipping Area', 'Shipping', '', 'Shipping', 'yes'],
    ['CMM-001', 'CMM Inspection 1', 'Quality Lab', 'Incoming Inspection', '', 'Quality', 'yes'],
    ['QUOTE-001', 'Quoting Station', 'Front Office', 'Quoting', 'Day Shift Team', 'Admin', 'yes'],
    ['ENG-001', 'Engineering Station', 'Engineering Office', 'Engineering Review', 'Day Shift Team', 'Engineering', 'yes'],
    ['CAM-001', 'CAM Programming Station', 'Engineering Office', 'CAM Programming', 'Day Shift Team', 'Engineering', 'yes'],
    ['PUR-001', 'Purchasing Station', 'Front Office', 'Purchasing', 'Day Shift Team', 'Admin', 'yes'],
    ['REC-001', 'Receiving Station', 'Receiving Area', 'Receiving', 'Day Shift Team', 'Admin', 'yes'],
    ['TOOL-001', 'Tool Crib Station', 'Tool Crib Area', 'Tool Crib', 'Day Shift Team', 'Machining', 'yes'],
    ['FINSP-001', 'Final Inspection Station', 'Quality Lab', 'Final Inspection', 'Quality Team', 'Quality', 'yes'],
    ['GRIND-001', 'Grinding Station', 'CNC Bay 2', 'Grinding', 'Day Shift Team', 'Machining', 'yes'],
    ['ASSY-001', 'Assembly Station 1', 'Assembly Area', 'Hardware Installation', 'Day Shift Team', 'Assembly', 'yes'],
  ],
  validValues: {
...
export const DEPARTMENTS_TEMPLATE = {
  ...
  sampleData: [
    ...
    ['Machining - Night', 'Night Shift Team', 'CNC milling and lathe operations - night shift'],
    ...
    ['Engineering', 'Day Shift Team', 'Engineering review and CAM programming'],
    ['Admin', 'Day Shift Team', 'Quoting, purchasing, and receiving operations'],
  ],
  validValues: {},
};
...
export const WORK_ORDERS_TEMPLATE = {
  ...
  sampleData: [
    ['WO-2026-001', 'Bracket Assembly', 'BRK-1234', '10', '50', 'normal', 'pending', 'CNC-001', 'Day Shift Team', '2026-03-15', '120', 'rush,aerospace', 'Machine brackets per drawing REV-B'],
    ['WO-2026-002', 'Housing Machining', 'HSG-5678', '20', '25', 'high', 'queued', 'LATHE-001', 'Night Shift Team', '2026-03-12', '240', 'priority', 'Turn housing components'],
    ['WO-2026-003', 'Cover Plate Inspection', 'CVR-9012', '30', '100', 'normal', 'pending', 'INSP-001', 'Quality Team', '2026-03-20', '60', '', 'Final inspection of cover plates'],
    ['WO-2026-004', 'Shaft Grinding', 'SFT-3456', '40', '10', 'urgent', 'pending', '', 'Day Shift Team', '2026-03-10', '180', 'hot-job,customer-urgent', 'Precision grinding per spec'],
    ['WO-2026-005', 'Prototype Frame', 'FRM-7890', '10', '2', 'critical', 'in_progress', 'WELD-001', 'Welding Team', '2026-03-08', '480', 'prototype,engineering', 'New product prototype frame'],
  ],
  validValues: {
...
export const ROUTING_TEMPLATE = {
  ...
  sampleData: [
    ['Standard Manufacturing', 'PART-*', '1', 'Quote Review & Approval', 'quote', 'Front Office', '30', '', 'Review quote and customer requirements'],
    ['Standard Manufacturing', 'PART-*', '2', 'Engineering Review', 'engineering', 'Engineering Office', '60', '', 'Review drawings, tolerances, and material specs'],
    ['Standard Manufacturing', 'PART-*', '3', 'Programming/CAM', 'engineering', 'Engineering Office', '120', '', 'Create CNC programs and toolpaths'],
    ['Standard Manufacturing', 'PART-*', '4', 'Materials Purchasing', 'purchasing', 'Front Office', '30', '', 'Order raw materials and special tooling'],
    ['Standard Manufacturing', 'PART-*', '5', 'Materials Receiving', 'receiving', 'Receiving Area', '15', '', 'Receive and verify material certifications'],
    ['Standard Manufacturing', 'PART-*', '6', 'Incoming Inspection', 'inspection', 'Quality Lab', '30', '', 'Verify material dimensions and condition'],
    ['Standard Manufacturing', 'PART-*', '7', 'Material Cutting/Prep', 'internal', 'Cutting Area', '30', '', 'Cut material to rough size'],
    ['Standard Manufacturing', 'PART-*', '8', 'Tool Setup & Prep', 'internal', 'Tool Crib Area', '45', '', 'Pull and verify tooling, fixtures, and gages'],
    ['Standard Manufacturing', 'PART-*', '9', 'First Article Setup', 'internal', 'CNC Bay 1', '90', '', 'Setup machine and run first article'],
    ['Standard Manufacturing', 'PART-*', '10', 'First Article Inspection', 'inspection', 'Quality Lab', '60', '', 'Full dimensional inspection per drawing'],
    ['Standard Manufacturing', 'PART-*', '11', 'Production Run', 'internal', 'CNC Bay 1', '240', '', 'Complete production quantity'],
    ['Standard Manufacturing', 'PART-*', '12', 'Deburr/Finish', 'internal', 'Finishing Area', '30', '', 'Remove burrs and clean parts'],
    ['Standard Manufacturing', 'PART-*', '13', 'Heat Treat', 'outside_processing', '', '480', 'ABC Heat Treat', 'HRC 58-62 per spec'],
    ['Standard Manufacturing', 'PART-*', '14', 'Final Inspection', 'inspection', 'Quality Lab', '30', '', 'Final QC check before shipping'],
    ['Standard Manufacturing', 'PART-*', '15', 'Packaging', 'internal', 'Shipping Area', '15', '', 'Package per customer requirements'],
    ['Standard Manufacturing', 'PART-*', '16', 'Ship to Customer', 'shipping', 'Shipping Area', '15', '', 'Generate shipping labels and ship'],
  ],
  validValues: {
...
export const INSTRUCTIONS_TEMPLATE = {
  ...
  sampleData: [
    ...
    ['', '', '', '', ''],
    ['Routing Templates', 'Template Name', 'Yes', '', 'Name of the routing template'],
    ['Routing Templates', 'Part Number Pattern', 'Yes', '', 'Wildcard pattern to match part numbers (e.g., PART-*)'],
    ['Routing Templates', 'Step #', 'Yes', '', 'Sequential step number within the template'],
    ['Routing Templates', 'Operation Name', 'Yes', '', 'Name of the operation/step'],
    ['Routing Templates', 'Type', 'Yes', 'See Valid Values sheet', 'Step type (quote, engineering, internal, etc.)'],
    ['Routing Templates', 'Work Center', 'No', '', 'Physical area where step is performed'],
    ['Routing Templates', 'Est. Duration (min)', 'No', '', 'Estimated minutes to complete the step'],
    ['Routing Templates', 'Vendor (if outside)', 'No', '', 'Vendor name for outside processing steps'],
    ['Routing Templates', 'Instructions', 'No', '', 'Detailed instructions for the operation'],
    ['', '', '', '', ''],
    ...
    ['', '5. Routing Templates', '', '', 'Routing Templates define standard operation sequences'],
    ['', '6. Work Orders', '', '', 'Work Orders depend on Teams and Stations'],
  ],
  validValues: {},
};
