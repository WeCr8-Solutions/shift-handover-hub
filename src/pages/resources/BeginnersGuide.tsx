        ...
        <main className="container py-12 max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Everything you need to know before your first day on the shop floor — from reading blueprints
              and understanding CNC to quality inspection and lean manufacturing fundamentals.
            </p>
          </div>
