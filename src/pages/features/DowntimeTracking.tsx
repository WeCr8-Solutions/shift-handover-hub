        ...
        <section className="py-16 sm:py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
              You can't reduce what you don't measure. JobLine.ai makes it easy to log, categorize, and analyze downtime events â€” so you can fix root causes and keep machines running.
            </p>
