        ...
        <div className="flex items-center justify-between gap-2">
          ...
          {!isMobile && (
            <div className="flex items-center gap-1 min-w-0 overflow-hidden flex-1">
              ...
              {hasOrgSupervisorAccess && <NavIconButton to="/packages" icon={PackageIcon} label="Packages" />}
                    ...
                    {user && (
                      <>
                        ...
                        <nav className="flex flex-col gap-1">
                          ...
                          {hasOrgSupervisorAccess && <MobileNavLink to="/packages" icon={PackageIcon} label="Packages" onClose={() => setMobileMenuOpen(false)} />}
