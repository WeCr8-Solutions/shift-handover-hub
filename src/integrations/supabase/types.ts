  ...
  public: {
    Tables: {
      ...
      admin_audit_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "admin_audit_events_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organization_billing_identifiers"
            referencedColumns: ["organization_id"]
      ...
      billing_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "billing_notes_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organization_billing_identifiers"
            referencedColumns: ["organization_id"]
      ...
      email_delivery_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "email_delivery_events_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
      ...
      org_health_snapshots: {
        ...
        Relationships: [
          {
            foreignKeyName: "org_health_snapshots_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organization_billing_identifiers"
            referencedColumns: ["organization_id"]
      ...
      policy_acceptances: {
        ...
        Relationships: [
          {
            foreignKeyName: "policy_acceptances_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organization_billing_identifiers"
            referencedColumns: ["organization_id"]
      ...
      policy_versions: {
        ...
        Relationships: [
          {
            foreignKeyName: "policy_versions_linked_announcement_id_fkey"
            columns: ["linked_announcement_id"]
            isOneToOne: false
            referencedRelation: "policy_change_announcements"
            referencedColumns: ["id"]
          },
      ...
      recruiter_messaging_limits: {
        ...
        Relationships: [
          {
            foreignKeyName: "recruiter_messaging_limits_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organization_billing_identifiers"
            referencedColumns: ["organization_id"]
      ...
      talent_abuse_reports: {
        ...
        Relationships: [
          {
            foreignKeyName: "talent_abuse_reports_reported_organization_id_fkey"
            columns: ["reported_organization_id"]
            isOneToOne: false
            referencedRelation: "organization_billing_identifiers"
            referencedColumns: ["organization_id"]
          },
    ...
    Views: {
      ...
      organizations_safe: {
        Row: {
          ...
          employer_locations: string[] | null
          employer_logo_url: string | null
          employer_paid_contact: boolean | null
          employer_paid_contact_until: string | null
          employer_tagline: string | null
          employer_website: string | null
          id: string | null
          ...
          oap_default_recert_months: number | null
          organization_kind:
            | Database["public"]["Enums"]["organization_kind"]
            | null
          public_employer: boolean | null
          public_slug: string | null
          requires_us_person_declaration: boolean | null
          slug: string | null
          subscription_status: string | null
